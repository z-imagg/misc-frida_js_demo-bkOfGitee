...
//MyTsCRst//_replaceSubStrInNextLine("_appName_" ,  _fileName(_jsonLoad0("./config.json","$.appPath")) , curNextLn )
const g_appName: string = "app.elf";

// 以命令MyTsCmd导入文件 _focus_fnAdr.ts
//MyTsCRst//_replaceCurLineByTsFileContent("./_focus_fnAdr.ts" , curNextLn)
...
//MyTsCRst//_replaceCurLineByTsFileContent("./_nativeFn_func01.ts" , curNextLn)
